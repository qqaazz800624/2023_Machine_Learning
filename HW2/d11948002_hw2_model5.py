...
weight_decay = 0.03
model_path = './model5.ckpt'  # the path where the checkpoint will be saved
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[7, 14, 21], gamma=0.5)
print(model)
#%%
...
with open('/home/u/qqaazz800624/2023_Machine_Learning/HW2/outputs/d11948002_hw2_model5.csv', 'w') as f:
    f.write('Id,Class\n')

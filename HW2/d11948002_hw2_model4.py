...
weight_decay = 0.03
model_path = f'./{_exp}.ckpt'  # the path where the checkpoint will be saved
...
with open(f'/home/u/qqaazz800624/2023_Machine_Learning/HW2/outputs/d11948002_hw2_{_exp}.csv', 'w') as f:
    f.write('Id,Class\n')
